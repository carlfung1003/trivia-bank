...
plus 567 authored clues for The Board and 956 survey answers for The Street.
...
- **Five surveys per run** drawn from 153 boards, the last three at double and triple value.
...
- **Categories have variants.** 72 headings across 107 packs: a heading like DIM SUM
...
data/jeopardy.json    107 clue packs (72 headings) + 32 finals
data/surveys.json     153 survey boards, for The Street
```
